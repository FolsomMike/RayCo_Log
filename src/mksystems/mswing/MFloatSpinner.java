...
*    //use doubleSpinner1.getDoubleValue() to retrieve the value as a double
*    
...
//
// The type of object returned from getValue can be either an Integer or a
// Double, so try returning as an integer first and then converting from a
// Double if that fails.
//

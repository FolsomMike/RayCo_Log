...
public class Viewer extends ViewerReporter implements WindowListener,
    ...
    //WIP HSS// use later //PrintRange printRange, printCalsRange;
...
public void configure()
{
    ...
    printProgress.init();*/ //WIP HSS// will use later
...
public void handleSizeChanges()
{
    ...
    for (int i = 0; i < numberOfChartGroups; i++) {
        chartGroups[i].updateDimensions();
    }
...
void startPrint()
{
    ...
    }//if (job.printDialog(aset))*/ //WIP HSS// you will use later
...
public int print(Graphics g, PageFormat pPF, int pPage) throws
    ...
    //WIP HSS// use later //if (printProgress.userCancel) {return(NO_SUCH_PAGE);}
    ...
    if (pPage != printCallPageTrack){
        ...
        if (startPiece != -1) {
            ...
            //WIP HSS// use later //printProgress.setLabel(currentSegmentNumber);
...
public void displayPrintProgressDialog()
{
    ...
    printProgress.setVisible(true);*/ //WIP HSS// will use later
...
public int getDataWidth()
{
    ...
    return(chartGroups[0].getChart(0).getTrace(0, 0).getDataIndex());
...
public void displayPrintRangeWindow()
{
    ...
    }//if (dialog.okToPrint)*/ //WIP HSS// use later
...
public void setScrollPaneSizes(int pWidth, int pHeight)
{
    ...
    Tools.setSizes(scrollPane, pWidth, pHeight);
...
public void windowClosing(WindowEvent e)
{
    ...
    //WIP HSS// use later //printProgress.userCancel = true;
...
public ViewerControlPanel(SharedSettings pSettings, String pCurrentJobName,
...
private void configure(/*IniFile pConfigFile*/)
{
    ...
    Tools.setSizes(printMultiple, 65, 43);
    ...
    Tools.setSizes(paperSizeSelector, 150, 25);
    ...
    Tools.setSizes(printWidthSelector, 150, 25);
    ...
    segmentEntry.setToolTipText("Enter the " + settings.pieceDescriptionLC +
                                                      " number to be loaded.");
    Tools.setSizes(segmentEntry, 70, 22);
...
public void actionPerformed(ActionEvent e)
{
    ...
    if ("Select Graph Print Layout".equals(e.getActionCommand())) {
        ...
        //WIP HSS// use later//settings.graphPrintLayout = (String)cb.getSelectedItem();
        }

    if ("Select Print Width".equals(e.getActionCommand())) {
        JComboBox cb = (JComboBox)e.getSource();
        //WIP HSS// use later//settings.userPrintWidth = (String)cb.getSelectedItem();
        }
